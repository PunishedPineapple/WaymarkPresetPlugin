...
namespace WaymarkPresetPlugin
{
	...
	{
		//	Construction
		public PluginUI( Configuration configuration, DalamudPluginInterface pluginInterface, DataManager dataManager, CommandManager commandManager, GameGui gameGui, ClientState clientState )
		{
			...
			mMapTestWindow = new( clientState, gameGui, dataManager );
		}
		...
		public readonly MapTestWindow mMapTestWindow;
